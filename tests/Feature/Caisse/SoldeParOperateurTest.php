...
class SoldeParOperateurTest extends TestCase
{
    ...
    public function test_retrait_refuse_si_solde_de_loperateur_choisi_est_insuffisant_meme_si_le_total_suffit(): void
    {
        ...
        $masrivi = Operateur::create(['tenant_id' => $tenant->id, 'nom' => 'Masrivi', 'bareme_depot' => ['tranches' => []], 'bareme_retrait_client' => ['tranches' => [['min' => 0, 'max' => null, 'frais' => 100]]], 'bareme_retrait_beneficiaire' => ['tranches' => []], 'pourcentage_partage_point' => 50]);
